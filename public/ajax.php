            ...
            if (!preg_match('/.xml/', $_FILES['arquivoImporta']['name'])) {
                ...
                foreach($xml->curso as $item){
                    ...
                    if (!mysqli_num_rows($query)){
                        $sql = "INSERT INTO courses (id, name, created_at, updated_at) VALUES ('".$item->codigo."', '".utf8_decode($item->nome)."', now(), now())";
...
<                           </tr>
    ...
    case "editar":
        switch ($_REQUEST['table']){
            case "alunos":
                ...
                break;
            case "cursos":
                $sql = "UPDATE courses SET name = '".utf8_decode($_REQUEST['nomeEdicao'])."', updated_at = now() WHERE id = '".$_REQUEST['idEdicao']."'";
                $artigo = "o";
                break;
            case "tiposDocumento":
                $sql = "UPDATE type_documents SET name = '".utf8_decode($_REQUEST['nomeEdicao'])."', status = '".utf8_decode($_REQUEST['statusEdicao'])."', updated_at = now() WHERE id = '".$_REQUEST['idEdicao']."'";
                $artigo = "o";
                break;
            case "clientes":
                $sql = "UPDATE clients SET name = '".utf8_decode($_REQUEST['nomeEdicao'])."', email = '".utf8_decode($_REQUEST['emailEdicao'])."', cel = '".$_REQUEST['celularEdicao']."', typeDocument = '".$_REQUEST['tipoDocumentoEdicao']."', document = '".$_REQUEST['documentoEdicao']."'";
                ...
                break;
            case "tiposProduto":
                $sql = "UPDATE types_products SET name = '".utf8_decode($_REQUEST['nomeEdicao'])."', status = '".utf8_decode($_REQUEST['statusEdicao'])."', updated_at = now() WHERE id = '".$_REQUEST['idEdicao']."'";
                $artigo = "o";
                break;
            case "produto":
                $sql = "UPDATE products SET name = '".utf8_decode($_REQUEST['nomeEdicao'])."', description = '".utf8_decode($_REQUEST['descricaoEdicao'])."', status = '".utf8_decode($_REQUEST['statusEdicao'])."'";
                $sql .= ", updated_at = now() WHERE id = '".$_REQUEST['idEdicao']."'";
                $artigo = "o";
                if ($_FILES['imagemEdicao'] && $_FILES['imagemEdicao']['error'] == 0){
                    $filesImg = $_FILES['imagemEdicao']['tmp_name'];
                ...
                break;
            case "formaPagamento":
                $sql = "UPDATE payment_methods SET name = '".utf8_decode($_REQUEST['nomeEdicao'])."'";
                $sql .= ", updated_at = now() WHERE id = '".$_REQUEST['idEdicao']."'";
                $artigo = "o";
                if ($_FILES['imagemEdicao'] && $_FILES['imagemEdicao']['error'] == 0){
                    $filesImg = $_FILES['imagemEdicao']['tmp_name'];
                ...
                break;
            case "dominio":
                $sql = "UPDATE domines SET alias = '".utf8_decode($_REQUEST['aliasEdicao']."', domine = '".$_REQUEST['dominioEdicao']."', user = '".$_REQUEST['usuarioEdicao']."', password = '".$_REQUEST['senhaEdicao']."'");
                $sql .= ", updated_at = now() WHERE id = '".$_REQUEST['idEdicao']."'";
                $artigo = "o";
                break;
            case "pagina":
                $sql = "UPDATE pages SET name = '".utf8_decode($_REQUEST['nomeEdicao']."', description = '".$_REQUEST['descricaoEdicao']."', subname = '".$_REQUEST['subtituloEdicao']."', appearsMenu = '".$_REQUEST['apareceMenuEdicao']."', appearsSite = '".$_REQUEST['apareceSiteEdicao']."', status = '".$_REQUEST['statusEdicao']."'");
                $sql .= ", updated_at = now() WHERE id = '".$_REQUEST['idEdicao']."'";
                $artigo = "a";
                $qualE = "pages";
                if ($_FILES['imagemEdicao'] && $_FILES['imagemEdicao']['error'] == 0){
            ...
            case "subitem":
                ...
                break;
            case "tipoServico":
                $sql = "UPDATE types_services SET name = '".utf8_decode($_REQUEST['nomeEdicao'])."', status = '".utf8_decode($_REQUEST['statusEdicao'])."', updated_at = now() WHERE id = '".$_REQUEST['idEdicao']."'";
                $artigo = "o";
                break;
            case "tipoModulo":
                $sql = "UPDATE type_modules SET name = '".utf8_decode($_REQUEST['nomeEdicao'])."', status = '".utf8_decode($_REQUEST['statusEdicao'])."', updated_at = now() WHERE id = '".$_REQUEST['idEdicao']."'";
                $artigo = "o";
                break;
            case "modulo":
                $sql = "UPDATE modules SET name = '".utf8_decode($_REQUEST['nomeEdicao'])."', status = '".utf8_decode($_REQUEST['statusEdicao'])."', typeModule = '".$_REQUEST['tipoModuloEdicao']."', slug = '".$_REQUEST['urlAmigavelEdicao']."', updated_at = now() WHERE id = '".$_REQUEST['idEdicao']."'";
                $artigo = "o";
                break;
            case "prioridade":
                $sql = "UPDATE priorities SET name = '".utf8_decode($_REQUEST['nomeEdicao'])."', status = '".utf8_decode($_REQUEST['statusEdicao'])."', updated_at = now() WHERE id = '".$_REQUEST['idEdicao']."'";
                $artigo = "a";
                break;
            case "tipoVersao":
                $sql = "UPDATE type_versions SET name = '".utf8_decode($_REQUEST['nomeEdicao'])."', typeService = '".utf8_decode($_REQUEST['tipoServicoEdicao'])."', status = '".utf8_decode($_REQUEST['statusEdicao'])."', updated_at = now() WHERE id = '".$_REQUEST['idEdicao']."'";
                $artigo = "o";
                break;
            case "categoria":
                $sql = "UPDATE categories SET name = '".utf8_decode($_REQUEST['nomeEdicao'])."', typeService = '".utf8_decode($_REQUEST['tipoServicoEdicao'])."', status = '".utf8_decode($_REQUEST['statusEdicao'])."', updated_at = now() WHERE id = '".$_REQUEST['idEdicao']."'";
                $artigo = "a";
                break;
            case "parametroSite":
                $sql = "UPDATE param_sites SET name = '".utf8_decode($_REQUEST['nomeEdicao'])."', value = '".utf8_decode($_REQUEST['valorEdicao'])."', updated_at = now() WHERE id = '".$_REQUEST['idEdicao']."'";
                $artigo = "o";
                break;
            case "parametroAdmin":
                $sql = "UPDATE param_admins SET name = '".utf8_decode($_REQUEST['nomeEdicao'])."', value = '".utf8_decode($_REQUEST['valorEdicao'])."', updated_at = now() WHERE id = '".$_REQUEST['idEdicao']."'";
                $artigo = "o";
                break;
            case "versao":
                $sql = "UPDATE versions SET name = '".utf8_decode($_REQUEST['nomeEdicao'])."', description = '".utf8_decode($_REQUEST['descricaoEdicao'])."', date = '".utf8_decode($_REQUEST['dataEdicao'])."'";
                $sql .= ", updated_at = now() WHERE id = '".$_REQUEST['idEdicao']."'";
                $artigo = "a";
                if ($_FILES['imagemEdicao'] && $_FILES['imagemEdicao']['error'] == 0){
                    $filesImg = $_FILES['imagemEdicao']['tmp_name'];
    ...
    case "cadastrar":
        switch ($_REQUEST['table']){
            case "alunos":
                ...
                break;
            case "cursos":
                $sql = utf8_decode("INSERT INTO courses (name, created_at, updated_at) VALUES ('".$_REQUEST['nomeCadastro']."', now(), now())");
                $artigo = "o";
                break;
            case "tiposDocumento":
                $sql = utf8_decode("INSERT INTO type_documents (name, status, created_at, updated_at) VALUES ('".$_REQUEST['nomeCadastro']."', '".$_REQUEST['statusCadastro']."', now(), now())");
                $artigo = "o";
                break;
            case "tiposProduto":
                $sql = utf8_decode("INSERT INTO types_products (name, status, created_at, updated_at) VALUES ('".$_REQUEST['nomeCadastro']."', '".$_REQUEST['statusCadastro']."', now(), now())");
                $artigo = "o";
                break;
            case "produto":
                $sql = utf8_decode("INSERT INTO products (name, description, status, created_at, updated_at) VALUES ('".$_REQUEST['nomeCadastro']."', '".$_REQUEST['descricaoCadastro']."', '".$_REQUEST['statusCadastro']."', now(), now())");
                $artigo = "o";
                if ($_FILES['imagemCadastro'] && $_FILES['imagemCadastro']['error'] == 0){
                    $filesImg = $_FILES['imagemCadastro']['tmp_name'];
                    $nameImg = $_FILES['imagemCadastro']['name'];
                ...
                break;
            case "formaPagamento":
                $sql = utf8_decode("INSERT INTO payment_methods (name, created_at, updated_at) VALUES ('".$_REQUEST['nomeCadastro']."', now(), now())");
                $artigo = "o";
                if ($_FILES['imagemCadastro'] && $_FILES['imagemCadastro']['error'] == 0){
                    $filesImg = $_FILES['imagemCadastro']['tmp_name'];
                    $nameImg = $_FILES['imagemCadastro']['name'];
                ...
                break;
            case "dominio":
                $sql = utf8_decode("INSERT INTO domines (alias, domine, user, password, created_at, updated_at) VALUES ('".$_REQUEST['aliasCadastro']."', '".$_REQUEST['dominioCadastro']."', '".$_REQUEST['usuarioCadastro']."', '".$_REQUEST['senhaCadastro']."', now(), now())");
                $artigo = "o";
                break;
            case "pagina":
                $sql = utf8_decode("INSERT INTO pages (name, description, subname, appearsMenu, appearsSite, status, created_at, updated_at) VALUES ('".$_REQUEST['nomeCadastro']."', '".$_REQUEST['descricaoCadastro']."', '".$_REQUEST['subtituloCadastro']."', '".$_REQUEST['apareceMenuCadastro']."', '".$_REQUEST['apareceSiteCadastro']."', '".$_REQUEST['statusCadastro']."', now(), now())");
                $artigo = "a";
                $qualE = "pages";
                if ($_FILES['imagemCadastro'] && $_FILES['imagemCadastro']['error'] == 0){
                    $filesImg = $_FILES['imagemCadastro']['tmp_name'];
                ...
                break;
            case "subitem":
                $sql = utf8_decode("INSERT INTO subitems (page, name, description, subname, appearsImg, status, created_at, updated_at) VALUES ('".$_REQUEST['paginaCadastro']."', '".$_REQUEST['nomeCadastro']."', '".$_REQUEST['descricaoCadastro']."', '".$_REQUEST['subtituloCadastro']."', '".$_REQUEST['mostraImagemCadastro']."', '".$_REQUEST['statusCadastro']."', now(), now())");
                $artigo = "a";
                $qualE = "subitems";
                if ($_FILES['imagemCadastro'] && $_FILES['imagemCadastro']['error'] == 0){
                    $filesImg = $_FILES['imagemCadastro']['tmp_name'];
                ...
                break;
            case "tipoServico":
                $sql = utf8_decode("INSERT INTO types_services (name, status, created_at, updated_at) VALUES ('".$_REQUEST['nomeCadastro']."', '".$_REQUEST['statusCadastro']."', now(), now())");
                $artigo = "o";
                break;
            case "prioridade":
                $sql = utf8_decode("INSERT INTO priorities (name, status, created_at, updated_at) VALUES ('".$_REQUEST['nomeCadastro']."', '".$_REQUEST['statusCadastro']."', now(), now())");
                $artigo = "a";
                break;
            case "tipoVersao":
                $sql = utf8_decode("INSERT INTO type_versions (name, typeService, status, created_at, updated_at) VALUES ('".$_REQUEST['nomeCadastro']."', '".$_REQUEST['tipoServicoCadastro']."', '".$_REQUEST['statusCadastro']."', now(), now())");
                $artigo = "o";
                break;
            case "categoria":
                $sql = utf8_decode("INSERT INTO categories (name, typeService, status, created_at, updated_at) VALUES ('".$_REQUEST['nomeCadastro']."', '".$_REQUEST['tipoServicoCadastro']."', '".$_REQUEST['statusCadastro']."', now(), now())");
                $artigo = "a";
                break;
            case "parametroSite":
                $sql = utf8_decode("INSERT INTO param_sites (name, value, created_at, updated_at) VALUES ('".$_REQUEST['nomeCadastro']."', '".$_REQUEST['valorCadastro']."', now(), now())");
                $artigo = "o";
                break;
            case "parametroAdmin":
                $sql = utf8_decode("INSERT INTO param_admins (name, value, created_at, updated_at) VALUES ('".$_REQUEST['nomeCadastro']."', '".$_REQUEST['valorCadastro']."', now(), now())");
                $artigo = "o";
                break;
            case "versao":
                $sql = utf8_decode("INSERT INTO versions (name, description, date, created_at, updated_at) VALUES ('".$_REQUEST['nomeCadastro']."', '".$_REQUEST['descricaoCadastro']."', '".($_REQUEST['dataCadastro'])."', now(), now())");
                $artigo = "a";
                if ($_FILES['imagemCadastro'] && $_FILES['imagemCadastro']['error'] == 0){
                    $filesImg = $_FILES['imagemCadastro']['tmp_name'];
                    $nameImg = $_FILES['imagemCadastro']['name'];
            ...
            case "usuarios":
                ...
                break;
            case "tipoModulo":
                $sql = utf8_decode("INSERT INTO type_modules (name, status, created_at, updated_at) VALUES ('".$_REQUEST['nomeCadastro']."', '".$_REQUEST['statusCadastro']."', now(), now())");
                $artigo = "o";
                break;
            case "modulo":
                $sql = utf8_decode("INSERT INTO modules (typeModule, name, slug, status, created_at, updated_at) VALUES ('".$_REQUEST['tipoModuloCadastro']."', '".$_REQUEST['nomeCadastro']."', '".$_REQUEST['urlAmigavelCadastro']."', '".$_REQUEST['statusCadastro']."', now(), now())");
                $artigo = "o";
                break;
        }
        mysqli_query($con, $sql) or die(mysqli_error($con));
    ...
    case "visualizar":
        switch ($_REQUEST['table']){
            ...
            case "cursos":
                ...
                $vet2 = explode('-', $vet[0]);
                $row['updated_at'] = utf8_decode($vet2[2]."/".$vet2[1]."/".$vet2[0]." às ".$vet[1]."h");
                echo utf8_encode("1|-|Nome: <b>".$row['name']."</b><br>Data de Cadastro: <b>".$row['created_at']."</b><br>".utf8_decode("Data de Atualização").": <b>".$row['updated_at']."</b>");
                $artigo = "o";
                break;
            case "faleConosco":
            ...
            case "statusPedido":
                ...
                $vet2 = explode('-', $vet[0]);
                $row['updated_at'] = utf8_decode($vet2[2]."/".$vet2[1]."/".$vet2[0]." às ".$vet[1]."h");
                echo utf8_encode("1|-|Nome: <b>".$row['name']."</b><br>Sigla: <b>".$row['sigla']."</b><br>Data de Cadastro: <b>".$row['created_at']."</b><br>".utf8_decode("Data de Atualização").": <b>".$row['updated_at']."</b>");
                $artigo = "o";
                break;
            case "tiposDocumento":
            ...
            case "clientes":
                ...
                $vet2 = explode('-', $vet[0]);
                $row['updated_at'] = utf8_decode($vet2[2]."/".$vet2[1]."/".$vet2[0]." às ".$vet[1]."h");
                echo utf8_encode("1|-|Nome: <b>".$row['name']."</b><br>Email: <b>".$row['email']."</b><br>Celular: <b>".$row['cel']."</b><br>Tipo de Documento: <b>".$row['nomeTipoDocumento']."</b><br>Documento: <b>".$row['document']."</b><br>Data de Cadastro: <b>".$row['created_at']."</b><br>".utf8_decode("Data de Atualização").": <b>".$row['updated_at']."</b>");
                $artigo = "o";
                break;
            case "tiposProduto":
            ...
            case "formaPagamento":
                ...
                echo utf8_encode("1|-|Nome: <b>".$row['name']."</b><br>");
                if ($excluirImg) {
            ...
            case "dominios":
                ...
                $vet2 = explode('-', $vet[0]);
                $row['updated_at'] = utf8_decode($vet2[2]."/".$vet2[1]."/".$vet2[0]." às ".$vet[1]."h");
                echo utf8_encode("1|-|".utf8_decode("Aliás").": <b>".$row['alias']."</b><br>".utf8_decode("Domínio").": <b>".$row['domine']."</b><br>".utf8_decode('Usuário: ')."<b>".$row['user']."</b><br>");
                echo utf8_encode("Senha: <b>".$row['password']."</b><br>Data de Cadastro: <b>".$row['created_at']."</b><br>".utf8_decode("Data de Atualização").": <b>".$row['updated_at']."</b>");
                $artigo = "o";
                break;
            case "pagina":
                ...
                echo utf8_encode("1|-|Nome: <b>".$row['name']."</b><br>".utf8_decode("Subtítulo").": <b>".$row['subname']."</b><br>".utf8_decode("Descrição").": <b>".$row['description']."</b><br>");
                if ($excluirImg) {
                ...
                echo utf8_encode("Aparece no Menu: <b>".utf8_decode($apareceMenu)."</b><br>Aparece no Site: <b>".utf8_decode($apareceSite)."</b><br>Status: <b>".$status."</b><br>Data de Cadastro: <b>".$row['created_at']."</b><br>".utf8_decode("Data de Atualização").": <b>".$row['updated_at']."</b>");
                $artigo = "a";
                break;
            case "subitem":
    ...
    case "selecionaCliente":
        ...
        $query = mysqli_query($con, $sql);
        $row = mysqli_fetch_array($query);
        $html = "Nome do Cliente: <b>".utf8_encode($row['name'])."</b><br>
                Email do Cliente: <b>".utf8_encode($row['email'])."</b><br>
                Telefone do Cliente: <b>".utf8_encode($row['cel'])."</b><br>
                Tipo de Documento do Cliente: <b>".utf8_encode($row['nomeTipoDocumento'])."</b><br>
                Documento do Cliente: <b>".utf8_encode($row['document'])."</b> ";
    ...
    case "selecionaEndereco":
        ...
        $html = "Nome do Endereço: <b>".utf8_encode($row['name'])."</b><br>
                ...
                Estado do Endereço: <b>".utf8_encode($row['state'])."</b>";
        echo "1|-|".($html);
        break;
    case "pegaDados":
        switch ($_REQUEST['table']){
            case 'alunos':
                ...
                $query = mysqli_query($con, $sql);
                $row = mysqli_fetch_array($query);
                echo utf8_encode("1|-|".$row['id']."|-|".$row['name']."|-|".$row['registration']."|-|".$row['status']."|-|".$row['zip']."|-|".$row['address']."|-|".$row['number']."|-|".$row['complement']."|-|".$row['neighborhood']."|-|".$row['city']."|-|".$row['state']."|-|".$row['course']."|-|".$row['turma']);
                break;
            case 'cursos':
                $sql = "SELECT * FROM courses WHERE id = '".$_REQUEST['id']."'";
                $query = mysqli_query($con, $sql);
                $row = mysqli_fetch_array($query);
                echo utf8_encode("1|-|".$row['id']."|-|".$row['name']);
                break;
            case 'faleConosco':
            ...
            case 'statusPedido':
                ...
                $query = mysqli_query($con, $sql);
                $row = mysqli_fetch_array($query);
                echo utf8_encode("1|-|".$row['id']."|-|".$row['sigla']."|-|".$row['name']);
                break;
            case 'tipoDocumento':
            ...
            case 'clientes':
                ...
                $query = mysqli_query($con, $sql);
                $row = mysqli_fetch_array($query);
                echo utf8_encode("1|-|".$row['id']."|-|".$row['name']."|-|".$row['email']."|-|".$row['cel']."|-|".$row['typeDocument']."|-|".$row['document']);
                break;
            case 'tiposProduto':
            ...
            case 'produto':
                ...
                $query = mysqli_query($con, $sql);
                $row = mysqli_fetch_array($query);
                echo utf8_encode("1|-|".$row['id']."|-|".$row['name']."|-|".$row['status']."|-|".$row['description']."|-|".URL."itensVendaProduto.php?idProduto=".$_REQUEST['id']);
                break;
            case 'formaPagamento':
            ...
            case 'dominio':
                ...
                $query = mysqli_query($con, $sql);
                $row = mysqli_fetch_array($query);
                echo utf8_encode("1|-|".$row['id']."|-|".$row['alias']."|-|".$row['domine']."|-|".$row['user']."|-|".$row['password']);
                break;
            case 'pagina':
            ...
            case 'parametroAdmin':
                ...
                $query = mysqli_query($con, $sql);
                $row = mysqli_fetch_array($query);
                echo utf8_encode("1|-|".$row['id']."|-|".$row['name']."|-|".$row['value']."|-|".$row['status']);
                break;
            case 'parametroSite':
            ...
            case 'versao':
                ...
                $query = mysqli_query($con, $sql);
                $row = mysqli_fetch_array($query);
                echo utf8_encode("1|-|".$row['id']."|-|".$row['name']."|-|".$row['description']."|-|".$row['date']);
                break;
            case 'tipoModulo':
            ...
            case 'modulo':
                ...
                $query = mysqli_query($con, $sql);
                $row = mysqli_fetch_array($query);
                echo utf8_encode("1|-|".$row['id']."|-|".$row['name']."|-|".$row['status']."|-|".$row['typeModule']."|-|".$row['slug']);
                break;
            case 'usuarios':
    ...
    case 'verificaNovamente':
        switch ($_REQUEST['tela']) {
            ...
            <tbody>';
                    ...
                    <td style="padding:5px">' . utf8_encode($cursos->name) . '</td>
            ...
            <tbody>';
                    ...
                    <td style="padding:5px">' . utf8_encode($tipoModulo->name) . '</td>
            ...
            <tbody>';
                    ...
                    <td style="padding:5px">' . utf8_encode($modulo->nomeTipoModulo) . '</td>

                    <td style="padding:5px">' . utf8_encode($modulo->name) . '</td>
            ...
            case 'logs':
                ...
                if (mysqli_num_rows($query)) {
                    ...
                    <td style="padding:5px">' . utf8_encode($usuarios->nomeUsuario) . '</td>
    ...
    case "addPermissao":
        ...
        $sql = "INSERT INTO logs (user, action, created_at, updated_at) VALUES ('".$_REQUEST['userLog']."', '".utf8_decode("Adicionou a permissão de ".$permissao." o módulo ".$_REQUEST['module']."  do usuário  ").$_REQUEST['user']."', now(), now())";
        mysqli_query($con, $sql);
    ...
    case "removePermissao":
        ...
        $sql = "INSERT INTO logs (user, action, created_at, updated_at) VALUES ('".$_REQUEST['userLog']."', '".utf8_decode("Removeu a permissão de ".$permissao." o módulo ".$_REQUEST['module']."  do usuário  ").$_REQUEST['user']."', now(), now())";
        mysqli_query($con, $sql);
        $sql = "SELECT * FROM permissions WHERE module = '".$_REQUEST['module']."' AND user = '".$_REQUEST['user']."'";
        $query = mysqli_query($con, $sql);
        if (mysqli_num_rows($query)){
    ...
    case "pegaPermissaoUsuario":
        echo "1|-|";
        $sql = "INSERT INTO logs (user, action, created_at, updated_at) VALUES ('".$_REQUEST['user']."', '".utf8_decode("Visualizou as permissões do usuário  ").$_REQUEST['id']."', now(), now())";
        mysqli_query($con, $sql);
...
';
    ...
    case "editaItensVenda":
        ...
        $query = mysqli_query($con, $sql);
        $row = mysqli_fetch_array($query);
        echo utf8_encode("1|-|".$row['id']."|-|".$row['product_type']."|-|".$row['code']."|-|".$row['name']."|-|".number_format($row['value'], 2, ',', '.')."|-|".number_format($row['promotion'], 2, ',', '.')."|-|".$row['validity_promotion']."|-|".$row['status']);
        break;
    case "listarItensVenda":
        ...
        if (mysqli_num_rows($query)){
            while ($row = mysqli_fetch_array($query)){
                ?><div style="width:100%; padding:10px"id="itemVenda<?php echo $row['id']?>" onmouseover="this.style.backgroundColor='#F7F7F7'" onmouseout="this.style.backgroundColor='#FFFFFF'"><?php echo utf8_encode($row['name'])?> <img src="<?php echo URL?>img/editar.png" width="20" style="cursor:pointer" onclick="editaItemVenda('<?php echo $row['id']?>', '<?php echo URL?>', '<?php echo $_REQUEST['id']?>')"> <img src="<?php echo URL?>img/excluir.png" width="20" style="cursor:pointer" onclick="excluirItemVenda('<?php echo $row['id']?>', '<?php echo URL?>', '<?php echo $_REQUEST['id']?>')"></div><?php
            }
        }
        break;
    case "cadastrarItemVenda":
        ...
        $_REQUEST['promotion'] = str_replace(',', '.', $_REQUEST['promotion']);
        $sql = utf8_decode("INSERT INTO products_items (product, product_type, code, name, value, promotion, validity_promotion, status, created_at, updated_at) VALUES ('".$_REQUEST['product']."', '".$_REQUEST['product_type']."', '".$_REQUEST['code']."', '".$_REQUEST['name']."', '".$_REQUEST['value']."', '".$_REQUEST['promotion']."', '".$_REQUEST['validity_promotion']."', '".$_REQUEST['status']."', now(), now())");
        mysqli_query($con, $sql);
        echo "1|-|";
        break;
    case "editarItemVenda":
        ...
        $_REQUEST['promotion'] = str_replace('.', '', $_REQUEST['promotion']);
        $_REQUEST['promotion'] = str_replace(',', '.', $_REQUEST['promotion']);
        $sql = utf8_decode("UPDATE products_items SET product_type = '".$_REQUEST['product_type']."', code = '".$_REQUEST['code']."', name = '".$_REQUEST['name']."', value = '".$_REQUEST['value']."', promotion = '".$_REQUEST['promotion']."', validity_promotion = '".$_REQUEST['validity_promotion']."', status = '".$_REQUEST['status']."', updated_at = now() WHERE id = '".$_REQUEST['id']."'");
        mysqli_query($con, $sql);
        echo "1|-|";
        break;
...
';
    ...
    case "detalhesPedido":
        ...
        echo '1|-|<button type"button" class="close" onClick=fecha("detalhesPedido")><span aria-hidden="true">&times;</span></button>
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr>
                    <td style="text-align:center">'.utf8_encode($rowPedido['nomeCliente']).'</td>
        ...
        echo $vet2[2]."/".$vet2[1].'/'.$vet2[0].' às '.$vet[1].'h</td>
               ...
               <tr>
                ...
                <tr>
                    <td style="text-align:center">'.utf8_encode($rowPedido['nomeFormaPagamento']).'</td>
                    <td style="text-align:center">'.utf8_encode($rowPedido['nomeStatus']);
        ...
        echo '
            ...
            <b>Nome do Endereço:</b> '.utf8_encode($rowPedido['nomeEndereco']).'<br>
            <b>CEP do Endereço:</b> '.utf8_encode($rowPedido['cepEndereco']).'<br>
            <b>Endereço:</b> '.utf8_encode($rowPedido['endereco'].', '.$rowPedido['number']);
            if ($rowPedido['complement']){
                echo ', '.utf8_encode($rowPedido['complement']);
            }
            echo " - B. ".utf8_encode($rowPedido['neighborhood']." - ".$rowPedido['city']." - ".$rowPedido['state']);
        break;
    case "pegaPedidos":
    ...
    case "excluirEndereco":
        ...
        $query = mysqli_query($con, $sql);
        $row = mysqli_fetch_array($query);
        $sql = "INSERT INTO logs (user, action, created_at, updated_at) VALUES ('".$_REQUEST['user']."', '".utf8_decode("Excluiu o endereço do cliente ").$row['idClient']." - ID: ".$_REQUEST['id']."', now(), now())";
        mysqli_query($con, $sql);
    ...
    case "atualizarEndereco":
        $sql = "INSERT INTO logs (user, action, created_at, updated_at) VALUES ('".$_REQUEST['user']."', '".utf8_decode("Atualizou o endereço do cliente ").$_REQUEST['idCliente']." - ID: ".$_REQUEST['idEndereco']."', now(), now())";
        mysqli_query($con, $sql);
    ...
    case "visualizaEnderecos":
        echo '1|-|';
        $sql = "INSERT INTO logs (user, action, created_at, updated_at) VALUES ('".$_REQUEST['user']."', '".utf8_decode("Visualizou os endereços do cliente ").$_REQUEST['id']."', now(), now())";
        mysqli_query($con, $sql);
        ...
        if (!mysqli_num_rows($query)){
            ...
            while($row = mysqli_fetch_array($query)){
                ...
                echo utf8_encode(' - B. '.$row['neighborhood'].' - '.$row['city'].' - '.$row['state'].'</td><td><a onclick=abre("modalAtualizaEndereco'.$row['id'].$_REQUEST['id'].'") style="cursor:pointer"><img src="'.URL.'img/editar.png" width="20"></a> <img src="'.URL.'img/excluir.png" style="cursor: pointer" onclick=excluirEndereco("'.$row['id'].'","'.URL.'","'.$_REQUEST['id'].'","'.$_REQUEST['user'].'") width="20"></td></tr>');
                echo '<script>  
function retornoCEPAtualizaEndereco'.$row['id'].$_REQUEST['id'].'(conteudo) {
        ...
        if (!$_REQUEST['idCliente']) {
            ...
            if (!mysqli_num_rows($query)) {
                if ($_REQUEST['passwordCadastro'] != $_REQUEST['password2Cadastro']) {
                    ...
                    $sql = utf8_decode("INSERT INTO clients (name, email, cel, typeDocument, document, password, created_at, updated_at) VALUES ('" . $_REQUEST['nomeCadastro'] . "', '" . $_REQUEST['emailCadastro'] . "', '" . $_REQUEST['celularCadastro'] . "', '" . $_REQUEST['tipoDocumentoCadastro'] . "', '" . $_REQUEST['documentoCadastro'] . "', '" . md5($_REQUEST['passwordCadastro']) . "', now(), now())");
                    $query = mysqli_query($con, $sql);
    ...
    case "atualizarCadastro":
        ...
        if ($row['email'] != $_REQUEST['emailCadastro']){
            ...
            if (mysqli_num_rows($query)){
                ...
                $sql = utf8_decode("UPDATE clients SET name = '".$_REQUEST['nomeCadastro']."', email = '".$_REQUEST['emailCadastro']."', cel = '".$_REQUEST['celularCadastro']."', typeDocument = '".$_REQUEST['tipoDocumentoCadastro']."', document = '".$_REQUEST['documentoCadastro']."', updated_at = now() WHERE id = '".$_REQUEST['idCliente']."'");
                mysqli_query($con, $sql);
    ...
    case "atualizarSenha":
        ...
        elseif($_REQUEST['novaSenhaAlterarSenha'] != $_REQUEST['redigitoSenhaAlterarSenha']){
            ...
            $sql = utf8_decode("UPDATE clients SET password = '".md5($_REQUEST['novaSenhaAlterarSenha'])."', updated_at = now() WHERE id = '".$_REQUEST['idCliente']."'");
            mysqli_query($con, $sql);
            echo '1';
        }
        break;
    ...
    case "salvarNews":
        ...
        $query = mysqli_query($con, $sql);
        if (!mysqli_num_rows($query)) {
            $sql = "INSERT INTO newsletters (name, email, status, created_at, updated_at) VALUES ('" . utf8_decode($_REQUEST['emailNews'] . "', '" . $_REQUEST['emailNews']) . "', '1', now(), now())";
        }
        else{
    ...
    case "salvarContato":
        ...
        $email['assunto'] = utf8_decode("Email enviado pelo formulário de Fale Conosco do Site - BH Commerce - ".$_REQUEST['subject']);
        $email['cabecalho'] = "Content-Type: text/html; charset=iso-8859-1\n";
        $email['cabecalho'] .= "From: Henrique Marcandier - BH Commerce<henrique@bhcommerce.com.br>\nReply-To: Henrique Marcandier - BH Commerce<henrique@bhcommerce.com.br>";
        ...
        mail($email['nome'], $email['assunto'], $email['corpo'], $email['cabecalho']);
        $sql = "INSERT INTO messages (name, email, subject, phone, text, status, created_at, updated_at) VALUES ('".utf8_decode($_REQUEST['name']."', '".$_REQUEST['email']."', '".$_REQUEST['subject']."', '".$_REQUEST['phone']."', '".$_REQUEST['text'])."', '1', now(), now())";
        mysqli_query($con, $sql);
        echo "1";
        break;
    case "salvarEstados":
    ...
    case "selecionaProdutoPedido":
        ...
        if ($_REQUEST['id'] != 8) {
            ...
            if (mysqli_num_rows($query2)){
                while ($row2 = mysqli_fetch_array($query2)){
                    echo "<option value='" . $row2['id'] . "'>" . utf8_encode($row2['name'])." - ";
                    if ($row['promotion'] && $row['vlidity_promotion'] <= date('Y-m-d')) {
                        echo "R$" . number_format($row['promotion'], 2, ',', '.');
                    } else {
                        echo "R$" . number_format($row['value'], 2, ',', '.');
